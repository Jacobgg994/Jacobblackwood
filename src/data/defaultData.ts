/* ==============================================
   ...
   Last updated: 2026-05-13T14:15:16.763Z
   ============================================== */
...
export type SectionType = 'hero' | 'products' | 'benefits' | 'pricing' | 'reviews' | 'faq' | 'contact' | 'showcase'

export type ShowcaseItemType = 'image' | 'video'
...
export interface ShowcaseItem {
  ...
  videoUrl?: string // For video type (YouTube)
...
export const DATA_VERSION = '1778666334545'
...
export const defaultShowcase: ShowcaseData = {
  "badge": "Showcase",
  "title": "ตัวอย่างการใช้งานและวิดีโอแนะนำ",
  "description": "เรียนรู้วิธีการใช้งานผ่านวิดีโอและดูตัวอย่างการนำไปใช้จริงในธุรกิจ",
  "items": [
    {
      "id": "v1",
      "type": "video",
      "title": "GemLogin คืออะไร? สอนติดตั้งครบในคลิปเดียว | EP.1",
      "videoUrl": "https://www.youtube.com/watch?v=8uNilvlr8AA"
    },
    {
      "id": "v2",
      "type": "video",
      "title": "GemPhoneFarm EP.1 : การติดตั้งและเชื่อมต่อ",
      "videoUrl": "https://www.youtube.com/watch?v=EGT3dEuV5r8"
    },
    {
      "id": "e1",
      "type": "image",
      "title": "การทำ Multi-Account Marketing",
      "desc": "จัดการหลายบัญชีโซเชียลมีเดียพร้อมกันโดยไม่โดนแบน",
      "image": "https://img1.pic.in.th/images/ChatGPT-Image-May-9-2026-06_09_21-PM.png"
    },
    {
      "id": "e2",
      "type": "image",
      "title": "ระบบ Farm Facebook อัตโนมัติ",
      "desc": "เพิ่มประสิทธิภาพการจัดการเพจและกลุ่ม Facebook",
      "image": "https://img1.pic.in.th/images/ChatGPT-Image-May-9-2026-06_09_21-PM.png"
    }
  ]
}
